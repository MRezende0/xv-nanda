...
export function CheckIcon() {
  return (
    <svg viewBox="0 0 24 24" className="h-6 w-6 sm:h-7 sm:w-7" fill="none" aria-hidden="true">
      ...
      <path d="M8.4 12.3l2.4 2.4 4.8-5" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function DressCodeIcon() {
  return (
    <svg viewBox="0 0 24 24" className="h-6 w-6 sm:h-7 sm:w-7" fill="none" aria-hidden="true">
      <path
        d="M12 3.2c0 1-.8 1.8-1.8 1.8S8.4 4.2 8.4 3.2"
        stroke="currentColor"
        strokeWidth="1.4"
        strokeLinecap="round"
      />
      <path
        d="M12 5c-1.6 0-2.8 1-3.4 2.4L4 9.5l1.2 2.1 3-1.4-1 10.6h9.6l-1-10.6 3 1.4L20 9.5l-4.6-2.1C14.8 6 13.6 5 12 5Z"
        stroke="currentColor"
        strokeWidth="1.4"
        strokeLinejoin="round"
      />
